[![Code.org](fullteam-2023.jpg)](https://code.org)
...
## Meet the Engineering team at Code.org
...
Our developer experience may be different to what you’ve seen in your past roles. Working closely with our product team, we ship to production every weekday and we have a variety of cadences - sometimes you are writing code that goes live that day; other times you are on longer term projects - and while we do follow 2-weekly sprints, we do so in a lightweight way. We index towards getting the right things done the right way vs. taking a purist view of any particular methodology. [All our code](https://github.com/code-dot-org) is open source and we use JIRA and GitHub pull requests to track all of our work items. We also care a lot about quality and testing and are fortunate to have incredible support from [SauceLabs](https://saucelabs.com/), who help us run our suite of UI tests on various student devices (e.g., iPads) in their cloud device farm.
